...
export const createGalleryTopBooks = (arr) => {
  return `<h1 class="books_gallery-title">Best Sellers <span class="books_gallery-title-subject">Books</span></h1>
  ${arr.map(item => {const markup = `<h2 class="books_card-heading js-heading">${item.list_name}</h2>
