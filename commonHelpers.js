import"./assets/slider-63e5e033.js";import{a as g,t as L}from"./assets/vendor-da6d1e6a.js";async function w(){return await g.get("https://books-backend.p.goit.global/books/top-books")}async function S(o){return await g.get(`https://books-backend.p.goit.global/books/category?category=${o}`)}async function E(o){return await g.get(`https://books-backend.p.goit.global/books/${o}`)}const C="data:image/png;base64,",T="data:image/png;base64,",A=document.querySelector(".modal-body"),d=document.querySelector(".backdrop"),x=document.querySelector(".modal-close-btn");let a,r=[];const k="shoppingList",b=localStorage.getItem(k);b&&(r=JSON.parse(b));x.addEventListener("click",h);document.addEventListener("click",async o=>{try{const t=o.target.closest(".hardcover-item")||o.target.closest(".js-card");if(t){const e=t.id,s=(await E(e)).data,c={_id:s._id,book_image:s.book_image,title:s.title,list_name:s.list_name,description:s.description,author:s.author,buy_links:s.buy_links.slice(0,2)},l=U(c);M(),_(A,l),a&&a.parentNode&&a.parentNode.removeChild(a),a=document.createElement("button"),a.textContent=r.some(p=>p._id===e)?"Remove from Shopping List":"Add to Shopping List",a.classList.add("add-to-shopping-list-btn"),a.addEventListener("click",()=>{I(c)}),A.appendChild(a),localStorage.setItem(k,JSON.stringify(r))}}catch(t){console.error(t)}});d.addEventListener("click",o=>{o.target===d&&h()});document.addEventListener("keydown",o=>{o.key==="Escape"&&h()});function M(){d.style.display="block"}function h(){d.style.display="none"}function U(o){const{book_image:t,list_name:e,title:n,author:s,description:c}=o;return`<div class="image-container">
    ...
    <div class="list-container">
     ...
     `}function _(o,t){o.innerHTML=t}function I(o){if(!o||!o._id){console.error("Invalid book:",o);return}const t=r.findIndex(e=>e._id===o._id);t===-1?r.push(o):r.splice(t,1),localStorage.setItem(k,JSON.stringify(r)),a&&(a.textContent=r.some(e=>e._id===o._id)?"Remove from Shopping List":"Add to Shopping List")}const i=window.visualViewport.width,q=document.querySelector(".js-bookslist"),G=document.querySelector(".js-all"),D=()=>{if(i<768)return 1;if(i>=768&&i<1440)return 3;if(i>1440)return 5},V=o=>`<h1 class="books_galerry-title">Best Sellers <span class="books_galerry-title-subject">Books</span></h1>
  ${o.map(t=>`
